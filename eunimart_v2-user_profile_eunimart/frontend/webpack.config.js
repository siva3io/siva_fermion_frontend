...
module.exports = {
  ...
  mode: "development",
  output: {
    publicPath: "https://frontend.eunimart.com/profileBuild/",
    // publicPath: "http://localhost:4028/",
  },
  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      exposes: {
        './UserProfileEunimart':'./src/bootstrap',
        './UserOrganisationEunimart':'./src/bootstrap'
