...
export const LOCATION_TYPE_LIST = "LOCATION_TYPE_LIST";
export const LOCATION_BY_ID = "LOCATION_BY_ID";
...
export const INTEGRATED_CHANNELS_LIST = "INTEGRATED_CHANNELS_LIST";
