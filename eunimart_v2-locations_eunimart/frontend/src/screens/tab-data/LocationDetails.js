...
export default function locationDetails({ data, edit }) {
  ...
  return (
    <>
      ...
      <RemoteViewBox view_data={extraDetails} header={"External Details"} />

      {
        data && data?.location_details?.payment_mapping &&
