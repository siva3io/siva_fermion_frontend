...
const ASNCreate = () => {
  ...
  const locationsData = useSelector(
    state => state.fetchlocationsnData?.locationsData
  );
  ...
  useEffect(() => {
    if (
      ...
      mainData.Source_Document_Type?.id?.lookup_code == "SALES_ORDERS"
    ) {
      var newMainData = [];
      ...
      var newDispatchLocationFields = DispatchLocationFields.map(o => {
        if (o.key == "ShippingAddress_Receiver_Name")
          o.value =
            SalesViewdata?.customer_shipping_address?.contact_person_name;
        if (o.key == "ShippingAddress_Mobile_Number")
          o.value =
            SalesViewdata?.customer_shipping_address?.contact_person_number;
        if (o.key == "ShippingAddress_Email")
          o.value = SalesViewdata?.customer_shipping_address?.email;
        if (o.key == "ShippingAddress_address_line_1")
          o.value = SalesViewdata?.customer_shipping_address?.address_line_1;
        if (o.key == "ShippingAddress_address_line_2")
          o.value = SalesViewdata?.customer_shipping_address?.address_line_2;
        if (o.key == "ShippingAddress_address_line_3")
          o.value = SalesViewdata?.customer_shipping_address?.address_line_3;
        if (o.key == "ShippingAddress_Country")
          o.value = SalesViewdata?.customer_shipping_address?.country;
        if (o.key == "ShippingAddress_State")
          o.value = SalesViewdata?.customer_shipping_address?.state;
        //if(o.key=="ShippingAddress_District") o.value="??";
        if (o.key == "ShippingAddress_Zipcode")
          o.value = SalesViewdata?.customer_shipping_address?.pin_code;
        return o;
      });
      ...
      var newCustomerBillingAddressFields = CustomerBillingAddressFields.map(
        o => {
          if (o.key == "BillingAddress_Receiver_Name")
            o.value =
              SalesViewdata?.customer_billing_address?.contact_person_name;
          if (o.key == "BillingAddress_Mobile_Number")
            o.value =
              SalesViewdata?.customer_billing_address?.contact_person_number;
          if (o.key == "BillingAddress_Email")
            o.value = SalesViewdata?.customer_billing_address?.email;
          if (o.key == "BillingAddress_address_line_1")
            o.value = SalesViewdata?.customer_billing_address?.address_line_1;
          if (o.key == "BillingAddress_address_line_2")
            o.value = SalesViewdata?.customer_billing_address?.address_line_2;
          if (o.key == "BillingAddress_address_line_3")
            o.value = SalesViewdata?.customer_billing_address?.address_line_3;
          if (o.key == "BillingAddress_Country")
            o.value = SalesViewdata?.customer_billing_address?.country;
          if (o.key == "BillingAddress_State")
            o.value = SalesViewdata?.customer_billing_address?.state;
          //if(o.key=="BillingAddress_District") o.value="??";
          if (o.key == "BillingAddress_Zipcode")
            o.value = SalesViewdata?.customer_billing_address?.pin_code;
          return o;
        }
      );
  ...
  useEffect(() => {
    if (
      ...
      mainData &&
      mainData.Select_Source_Document &&
      mainData.Source_Document_Type?.id?.display_name == "Purchase Returns"
    ) {
      var newMainData = [];
      ...
      var newDispatchLocationFields = DispatchLocationFields.map(o => {
        if (o.key == "ShippingAddress_Receiver_Name")
          o.value =
            purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_shipping_address?.contact_person_name;
        if (o.key == "ShippingAddress_Mobile_Number")
          o.value =
            purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_shipping_address?.contact_person_number;
        if (o.key == "ShippingAddress_Email")
          o.value =
            purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_shipping_address?.email;
        if (o.key == "ShippingAddress_address_line_1")
          o.value =
            purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_shipping_address?.address_line_1;
        if (o.key == "ShippingAddress_address_line_2")
          o.value =
            purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_shipping_address?.address_line_2;
        if (o.key == "ShippingAddress_address_line_3")
          o.value =
            purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_shipping_address?.address_line_3;
        if (o.key == "ShippingAddress_Country")
          o.value =
            purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_shipping_address?.country?.name;
        if (o.key == "ShippingAddress_State")
          o.value =
            purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_shipping_address?.state?.name;
        if (o.key == "ShippingAddress_District")
          o.value =
            purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_shipping_address?.city;
        if (o.key == "ShippingAddress_Zipcode")
          o.value =
            purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_shipping_address?.pin_code;
        return o;
      });
      setDispatchLocationFields(newDispatchLocationFields);
      ...
      var newCustomerBillingAddressFields = CustomerBillingAddressFields.map(
        o => {
          if (o.key == "BillingAddress_Receiver_Name")
            o.value =
              purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_billing_address?.contact_person_name;
          if (o.key == "BillingAddress_Mobile_Number")
            o.value =
              purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_billing_address?.contact_person_number;
          if (o.key == "BillingAddress_Email")
            o.value =
              purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_billing_address?.email;
          if (o.key == "BillingAddress_address_line_1")
            o.value =
              purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_billing_address?.address_line_1;
          if (o.key == "BillingAddress_address_line_2")
            o.value =
              purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_billing_address?.address_line_2;
          if (o.key == "BillingAddress_address_line_3")
            o.value =
              purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_billing_address?.address_line_3;
          if (o.key == "BillingAddress_Country")
            o.value =
              purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_billing_address?.country?.name;
          if (o.key == "BillingAddress_State")
            o.value =
              purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_billing_address?.state?.name;
          if (o.key == "BillingAddress_District")
            o.value =
              purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_billing_address?.city;
          if (o.key == "BillingAddress_Zipcode")
            o.value =
              purchase_returnsViewdata?.vendor_details?.vendor_locations?.vendor_billing_address?.pin_code;
          return o;
        }
      );
      setCustomerBillingAddressFields(newCustomerBillingAddressFields);
        ...
        nweselectedProductData =
          purchase_returnsViewdata.purchase_return_lines.map(o => {
            return {
              ...
              package_length: o?.product_details?.product_dimensions?.length
                ? o?.product_details?.product_dimensions?.length
                : "",
              package_width: o?.product_details?.product_dimensions?.breadth
                ? o?.product_details?.product_dimensions?.length
                : "",
              package_height: o?.product_details?.product_dimensions?.height
                ? o?.product_details?.product_dimensions?.length
                : "",
      ...
      var newSchedule_Pickup_date_and_time = DateandTime.map(o => {
        if (o.key == "Schedule_Scrap_Date")
          o.value = moment(
            purchase_returnsViewdata?.pickup_date_and_time?.pickup_date
          ).format("YYYY-MM-DD");
        if (o.key == "Schedule_Pickup_time")
          o.value = o.value.map(p => {
            if (p.key == "Schedule_Pickup_time_from")
              p.value = moment(
                purchase_returnsViewdata?.pickup_date_and_time?.pickup_from_time
              );
            if (p.key == "Schedule_Pickup_time_to")
              p.value = moment(
                purchase_returnsViewdata?.pickup_date_and_time?.pickup_to_time
              );
            return p;
          });
        return o;
      ...
      var keyValuePairMainData = {
        newEstimated_Cost: 0,
        Estimated_Cost_Select: purchase_returnsViewdata.shipping_mode_id,
      };
  ...
  useEffect(() => {
    if (
      ...
      mainData &&
      mainData.Select_Source_Document &&
      mainData.Source_Document_Type?.id?.lookup_code == "PURCHASE_ORDERS"
    ) {
      var newMainData = [];

      var newASNDetailsFields = ASNDetailsFields.map(o => {
        if (o.key == "Reference_ID")
          o.value = purchase_ordersViewdata?.reference_number;
        return o;
      });
      setASNDetailsFields(newASNDetailsFields);
      ...
      var newDispatchLocationFields = DispatchLocationFields.map(o => {
        if (o.key == "ShippingAddress_Receiver_Name")
          o.value =
            purchase_ordersViewdata?.delivery_address?.contact_person_name;
        if (o.key == "ShippingAddress_Mobile_Number")
          o.value =
            purchase_ordersViewdata?.delivery_address?.contact_person_number;
        if (o.key == "ShippingAddress_Email")
          o.value = purchase_ordersViewdata?.delivery_address?.email;
        if (o.key == "ShippingAddress_address_line_1")
          o.value = purchase_ordersViewdata?.delivery_address?.address_line_1;
        if (o.key == "ShippingAddress_address_line_2")
          o.value = purchase_ordersViewdata?.delivery_address?.address_line_2;
        if (o.key == "ShippingAddress_address_line_3")
          o.value = purchase_ordersViewdata?.delivery_address?.address_line_3;
        if (o.key == "ShippingAddress_Country")
          o.value = purchase_ordersViewdata?.delivery_address?.country;
        if (o.key == "ShippingAddress_State")
          o.value = purchase_ordersViewdata?.delivery_address?.state;
        //if(o.key=="ShippingAddress_District") o.value="??";
        if (o.key == "ShippingAddress_Zipcode")
          o.value = purchase_ordersViewdata?.delivery_address?.pin_code;
        return o;
      });
      setDispatchLocationFields(newDispatchLocationFields);
      ...
      var newCustomerBillingAddressFields = CustomerBillingAddressFields.map(
        o => {
          if (o.key == "BillingAddress_Receiver_Name")
            o.value =
              purchase_ordersViewdata?.billing_address?.contact_person_name;
          if (o.key == "BillingAddress_Mobile_Number")
            o.value =
              purchase_ordersViewdata?.billing_address?.contact_person_number;
          if (o.key == "BillingAddress_Email")
            o.value = purchase_ordersViewdata?.billing_address?.email;
          if (o.key == "BillingAddress_address_line_1")
            o.value = purchase_ordersViewdata?.billing_address?.address_line_1;
          if (o.key == "BillingAddress_address_line_2")
            o.value = purchase_ordersViewdata?.billing_address?.address_line_2;
          if (o.key == "BillingAddress_address_line_3")
            o.value = purchase_ordersViewdata?.billing_address?.address_line_3;
          if (o.key == "BillingAddress_Country")
            o.value = purchase_ordersViewdata?.billing_address?.country;
          if (o.key == "BillingAddress_State")
            o.value = purchase_ordersViewdata?.billing_address?.state;
          //if(o.key=="BillingAddress_District") o.value="??";
          if (o.key == "BillingAddress_Zipcode")
            o.value = purchase_ordersViewdata?.billing_address?.pin_code;
          return o;
        }
      );
      setCustomerBillingAddressFields(newCustomerBillingAddressFields);
      ...
      if (purchase_ordersViewdata.purchase_order_lines)
        nweselectedProductData =
          purchase_ordersViewdata.purchase_order_lines.map(o => {
            return {
              id: o.product_id,
              sku_id: {
                id: o?.product_details?.id,
  ...
  useEffect(() => {
    if (
      ...
      mainData &&
      mainData.Select_Source_Document &&
      mainData.Source_Document_Type?.id?.lookup_code == "IST"
    ) {
      var newMainData = [];
      ...
      var newDispatchLocationFields = DispatchLocationFields.map(o => {
        ...
        if (o.key == "ShippingAddress_address_line_1")
          o.value = ISTViewdata?.destination_warehouse?.address?.address_line_1;
        if (o.key == "ShippingAddress_address_line_2")
          o.value = ISTViewdata?.destination_warehouse?.address?.address_line_2;
        if (o.key == "ShippingAddress_address_line_3")
          o.value = ISTViewdata?.destination_warehouse?.address?.address_line_3;
        if (o.key == "ShippingAddress_Country")
          o.value = ISTViewdata?.destination_warehouse?.address?.country?.name;
        if (o.key == "ShippingAddress_State")
          o.value = ISTViewdata?.destination_warehouse?.address?.state.name;
        //if(o.key=="ShippingAddress_District") o.value="??";
        if (o.key == "ShippingAddress_Zipcode")
          o.value = ISTViewdata?.destination_warehouse?.pin_code;
        return o;
      });
      setDispatchLocationFields(newDispatchLocationFields);
      ...
      var newDateandTime = DateandTime.map(o => {
        if (o.key == "Schedule_Pickup_date")
          o.value = moment(
            ISTViewdata?.pickup_date_and_time?.pickup_date
          ).format("YYYY-MM-DD");
  ...
  const handelInputChange = (key, value, index = null) => {
    ...
    if (index != null) {
      ...
      if (key === "sku_id") {
        ...
        newSelectedProductData[index]["price"] =
          selectVarient?.product_pricing_details?.mrp;
  ...
  const handelSelectonChange = (key, value) => {
    ...
    switch (key) {
      ...
      case "ShippingAddress_State": {
        setDispatchLocationFields(
          DispatchLocationFields?.map(o => {
  ...
  const handelCheckBoxonChange = field => {
    ...
    if (field.key == "auto_generate_asn_number") {
      var neworder = ASNDetailsFields.map(o => {
        if (o.key == "ASN_Number") o.disabled = !field.isChecked;
        return o;
      });
    ...
    var newState = ASNDetailsFields.map(o => {
      if (o.key == field.key) {
  ...
  const handleButtonClick = key => {
    ...
    const payload = {
      ...
      auto_generate_reference_number: ASNDetailsFields[5]?.isChecked
        ? true
        : false,
  ...
  return (
    <>
      ...
      <AddForm
        header={"ASN Details"}
        data={ASNDetailsFields.map(field => {
          switch (field?.key) {
            case "Source_Document_Type": {
              field.data = SourceDocument.map(curElem => {
                return { id: curElem, label: curElem.display_name };
              });
              break;
            }
            case "Select_Source_Document": {
              field.data =
                ...
                mainData.Source_Document_Type?.id?.lookup_code == "SALES_ORDERS"
                  ...
                  : mainData &&
                    mainData.Source_Document_Type &&
                    mainData.Source_Document_Type?.id?.display_name ==
                      "Purchase Returns"
                  ? SearchSourceDocument?.map(o => {
      ...
      <AddForm
        header={"Dispatch Location Details"}
        data={DispatchLocationFields.map(field => {
          switch (field?.key) {
            case "ShippingAddress_Country": {
              field.data = Countriesdata.map(o => {
                return { id: o.id, label: o.name };
              });
              break;
            }
            case "ShippingAddress_State": {
              field.data = states1.map(o => {
                return { id: o.id, label: o.name };
              });
              break;
            }
        ...
        setRadioType={setRadioType}
        IsButtonShow={false}
        ButtonText={"Search From Addresses"}
        handleButtonClick={handleButtonClick}
      />

      {/* //Delivery Location details */}
      <AddForm
        header={"Delivery Location details"}
