...
export const CreateSRConfig =(payload) => {
 return{ method: "post",
  url: `${base_URL}/api/v1/sales_returns/create`,
  data: payload,
  headers: { "Content-Type": "application/json" }}
  //   data: data,
};
export const sales_returns_update_config = (id,payload) => {
  if (payload) {
    let url = `${base_URL}/api/v1/sales_returns/${id}/update`;
    return {
      method: "post",
      url: url,
      data: payload,  
