...
- After running the project, change the path to access the Inventory table. For reference, follow the below path:
  ```bash
  http://localhost:4018/inventoryAdjustment
  ```
  ```bash
  http://localhost:4018/pickList
  ```
## Changelog
