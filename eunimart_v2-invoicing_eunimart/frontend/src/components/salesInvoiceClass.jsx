...
//salesInvoiceData
function SalesInvoiceViewClass({ salesInvoiceViewData }) {
  const [variant, setVariant] = useState(
    salesInvoiceViewData ? salesInvoiceViewData : []
  );
  const [variantProduct, setVariantProduct] = useState(
    salesInvoiceViewData
      ? salesInvoiceViewData
        ? salesInvoiceViewData.sales_invoice_lines
        : []
      : []
  );
  ...
  const [salesinvoicedetails, setsalesinvoicedetails] = useState([
    ...
    {
      label: "Invoice Date",
      text: variant && variant.created_date,
      type: "input",
    },
    {
    ...
    },
    {
      ...
      text:
        variant &&
        variant.link_sales_orders &&
        variant.link_sales_orders[0] &&
        variant.link_sales_orders[0].sales_order_number,
      type: "input",
    },
  ]);
  ...
  const [customerDeliveryDetails, setcustomerDeliveryDetails] = useState([
    {
      ...
      text:
        ...
        variant.delivery_address[0] &&
        variant.delivery_address[0].customer_name,
      type: "input",
    },
    {
      label: "Mobile Number",
      text:
        ...
        variant.delivery_address &&
        variant.delivery_address[0] &&
        variant.delivery_address[0].mobile_number,
      type: "input",
    },
    {
      label: "Email",
      text:
        ...
        variant.delivery_address &&
        variant.delivery_address[0] &&
        variant.delivery_address[0].email,
      type: "input",
    },
    {
      ...
      text:
        ...
        variant.delivery_address &&
        variant.delivery_address[0] &&
        variant.delivery_address[0].Address,
      type: "input",
    },
    {
      ...
      text:
        ...
        variant.delivery_address &&
        variant.delivery_address[0] &&
        variant.delivery_address[0].address_line_2,
      type: "input",
    },
    {
      ...
      text:
        ...
        variant.delivery_address &&
        variant.delivery_address[0] &&
        variant.delivery_address[0].address_line_3,
      type: "input",
    },
    {
      label: "Zipcode",
      text:
        ...
        variant.delivery_address &&
        variant.delivery_address[0] &&
        variant.delivery_address[0].zipcode,
      type: "input",
    },
    {
      label: "City / District",
      text:
        ...
        variant.delivery_address &&
        variant.delivery_address[0] &&
        variant.delivery_address[0].district,
      type: "input",
    },
    {
      label: "State",
      text:
        ...
        variant.delivery_address &&
        variant.delivery_address[0] &&
        variant.delivery_address[0].state,
      type: "input",
    },
    {
      label: "Country",
      text:
        ...
        variant.delivery_address &&
        variant.delivery_address[0] &&
        variant.delivery_address[0].country,
      type: "input",
    },
  ]);
  ...
  const [customerBillingDetails, setcustomerBillingDetails] = useState([
    {
      ...
      text:
        variant &&
        variant.billing_address &&
        variant.billing_address[0] &&
        variant.billing_address[0].customer_name,
      type: "input",
    },
    {
      label: "Mobile Number",
      text:
        ...
        variant.billing_address &&
        variant.billing_address[0] &&
        variant.billing_address[0].mobile_number,
      type: "input",
    },
    {
      label: "Email",
      text:
        ...
        variant.billing_address &&
        variant.billing_address[0] &&
        variant.billing_address[0].email,
      type: "input",
    },
    {
      label: "Address Line 1",
      text:
        ...
        variant.billing_address &&
        variant.billing_address[0] &&
        variant.billing_address[0].Address,
      type: "input",
    },
    {
      label: "Address Line 2",
      text:
        ...
        variant.billing_address &&
        variant.billing_address[0] &&
        variant.billing_address[0].address_line_2,
      type: "input",
    },
    {
      label: "Address Line 3",
      text:
        ...
        variant.billing_address &&
        variant.billing_address[0] &&
        variant.billing_address[0].address_line_3,
      type: "input",
    },
    {
      label: "Zipcode",
      text:
        ...
        variant.billing_address &&
        variant.billing_address[0] &&
        variant.billing_address[0].zipcode,
      type: "input",
    },
    {
      label: "City / District",
      text:
        ...
        variant.billing_address &&
        variant.billing_address[0] &&
        variant.billing_address[0].district,
      type: "input",
    },
    {
      label: "State",
      text:
        ...
        variant.billing_address &&
        variant.billing_address[0] &&
        variant.billing_address[0].state,
      type: "input",
    },
    {
      label: "Country",
      text:
        ...
        variant.billing_address &&
        variant.billing_address[0] &&
        variant.billing_address[0].country,
      type: "input",
    },
  ]);
  ...
  const [paymentTerms, setpaymentTerms] = useState([
    {
      label: "Payment Terms",
      text:
        variant && variant.payment_terms && variant.payment_terms.lookup_code,
      type: "input",
    },
    {
  ...
  const [additionalInformation, setadditionalInformation] = useState([
    {
      label: "Notes",
      text: variant && variant.internal_notes,
      type: "input",
    },
    {
  ...
  const [paymentDetails, setpaymentDetails] = useState([
    {
      label: "Sub Total",
      text: variant && variant.sub_total_amount,
      type: "input",
    },
    {
      label: "Tax",
    ...
    },
    {
      ...
      text:
        ...
        variantProduct[0].products &&
        variantProduct[0].products.shipping_options &&
        variantProduct[0].products.shipping_options.shipping_cost,
      type: "input",
    },
          ...
          <div className="locationDetailsMain">
            ...
            <div className="product-staticFormCardForm">
              <Box className="labeledTextWrapper">
                <p>
                  <label>{"Note:"}</label>
                  {"You have set the  common payment term for the entire order"}
                </p>
              </Box>
                  ...
                  <Box className="labeledTextWrapper">
                    <Box className="labelWrap_card">
                      <Typography
                        ...
                        className="commonlabel_disabled"
                      >
                        {field.label}
                      </Typography>
                    </Box>
      ...
      <Suspense fallback={<div>Loading... </div>}>
        <RemoteWrapper>
          {variantProduct && (
            <RemoteViewBox_Table
              headCells={headCells}
              table_data={variantProduct.map(item => {
                return {
                  sku_code:
                  ...
                  warehouse_id:
                    item && item.warehouse && item.warehouse.name
                      ...
                      : "--",
                  inventory_id:
                    item && item.inventory && item.inventory.channel_code
                      ? item.inventory.channel_code
                      : "--",
                  description:
                  ...
                  serial_number:
                    item &&
                    item.inventory &&
                    item.inventory.product_details &&
                    item.inventory.product_details.serial_number
                      ? item.inventory.product_details.serial_number
                      : "--",
                  uom:
                  ...
                  total_amount:
                    item && item.total_amount ? item.total_amount : 0,
                };
              })}
