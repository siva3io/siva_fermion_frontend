...
export const loadPruchaseInvoiceData = param => {
  return function (dispatch) {
    ...
    axios
      .get(`${BASE_API_SOURCE.url}api/v1/purchase_invoice`, { params, headers })
      .then(resp => {
...
export const Save_Purchase_Invoice = (data, callback) => {
  return function (dispatch) {
    ...
    axios
      .post(
        `${BASE_API_SOURCE.url}api/v1/purchase_invoice/create`,
        JSON.stringify(data),
        { headers }
      )
      .then(resp => {
...
export const loadDeleteDataById = (deleteId, callback) => {
  return function (dispatch) {
    ...
    axios
      .delete(
        `${BASE_API_SOURCE.url}api/v1/purchase_invoice/${deleteId}/delete`,
        { headers }
      )
      .then(resp => {
...
export const Update_Purchase_Invoice_Orders = (id, data, callback) => {
  return function (dispatch) {
    ...
    axios
      .post(
        `${BASE_API_SOURCE.url}api/v1/purchase_invoice/${id}/update`,
        JSON.stringify(data),
        { headers }
      )
      .then(resp => {
...
export const loadSOURCE_DOCUMENTData = () => {
  return function (dispatch) {
    ...
    axios
      .get(
        `${BASE_API_SOURCE.url}api/v1/core/lookup_codes/PURCHASE_INVOICE_SOURCE_DOCUMENT_TYPES`,
        { headers }
      )
      .then(resp => {
...
export const deleteSalesInvoiceInvoice = id => {
  ...
  return function (dispatch) {
    ...
    axios
      .delete(`${BASE_API_SOURCE.url}api/v1/sales_invoice/${id}/delete`, {
        headers,
      })
      .then(resp => {
...
export const Update_Sales_Invoice_Data = (id, data, callback) => {
  return function (dispatch) {
    ...
    axios
      .put(
        `${BASE_API_SOURCE.url}api/v1/sales_invoice/${id}/edit`,
        JSON.stringify(data),
        { headers }
      )
      .then(resp => {
...
export const Save_Sales_Invoice_Data = (data, callback) => {
  return function (dispatch) {
    ...
    axios
      .post(
        `${BASE_API_SOURCE.url}api/v1/sales_invoice/create`,
        JSON.stringify(data),
        { headers }
      )
      .then(resp => {
...
export const loadSISOURCE_DOCUMENTData = () => {
  return function (dispatch) {
    ...
    axios
      .get(
        `${BASE_API_SOURCE.url}api/v1/core/lookup_codes/sales_invoice_source_document_types`,
        { headers }
      )
      .then(resp => {
    ...
    axios
      ...
      .get(
        `${BASE_API_SOURCE.url}api/v1/template/${localStorage.getItem(
          "access_template_id"
        )}?filters=[["display_name","=","SALES_INVOICE"]]`,
        { headers }
      )
      .then(resp => {
  ...
  return function (dispatch) {
    ...
    axios
      ...
      .get(
        `${BASE_API_SOURCE.url}api/v1/template/${localStorage.getItem(
          "access_template_id"
        )}?filters=[["display_name","=","PURCHASE_INVOICE"]]`,
        { headers }
      )
      .then(resp => {
