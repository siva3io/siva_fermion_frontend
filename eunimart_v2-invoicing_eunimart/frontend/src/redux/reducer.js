...
const DataReducers =(state = initialState, action)=>{
    ...
    switch(action.type)
    {
        ...
        case types.PURCHASE_ORDER_LIST: return{
            ...state,
            PurchaseOrderdata:action.payload.data, 
            loading:false
        }        
        case types.PURCHASE_ORDER_VIEW: return{
            ...state,
        ...
        case types.SALES_ORDERS_LIST: return {
          ...
          case types.SI_SOURCE_DOCUMENT_LIST: return {
            ...state,
            SISourceDocumentTypesData: action.payload.data,
            loading: false
          }
          case types.SALES_ORDER_VIEW: return {
            ...state,
            SalesOrderViewdata: action.payload.data,
            loading: false
          }
          case types.SI_ACCESS_MANAGEMENT: return{
            ...state,
            siAccess:action.payload.data,
            loading:false
          }
          case types.PI_ACCESS_MANAGEMENT: return{
            ...state,
