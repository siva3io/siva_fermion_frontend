...
const DataReducers =(state = initialState, action)=>{
    ...
    switch(action.type)
    {
        case types.TEMPLATE_LIST: return{
            ...state,
            templateData:action.payload.data,
            templateMeta:action.payload.meta,
            loading:false
        } 
        case types.TEMPLATE_DETAILS: return{
            ...state,
            templateData:action.payload.data,
            loading:false
        }    
        case types.MODULE_LIST: return{
            ...state,
