...
export const loadTemplateData = () => { 
  return function (dispatch) {
    ...
    axios.get(`${BASE_API_SOURCE.url}api/v1/template/list`, { headers })
      .then((resp) => { 
...
export const loadTemplateDetailsData = (id) => { 
  return function (dispatch) {
    ...
    axios.get(`${BASE_API_SOURCE.url}api/v1/template/${id}`, { headers })
      .then((resp) => { 
...
export const loadTemplateCreate = (data, callback) => { 
    ...
    axios.post(`${BASE_API_SOURCE.url}api/v1/template/create`, JSON.stringify(data), { headers })
      .then((resp) => { 
        callback(resp.data);
      })
...
export const loadTemplateUpdate = (id, data, callback) => { 
  ...
  axios.post(`${BASE_API_SOURCE.url}api/v1/template/${id}/update`, JSON.stringify(data), { headers })
    .then((resp) => { 
      callback(resp.data);
    })
    .catch((error) => {console.log(error); callback(error)});
...
export const loadModuleData = (param) => { 
  return function (dispatch) { 
    ...
    axios.get(`${BASE_API_SOURCE.url}/api/v1/module/core_module`, { params, headers })
      .then((resp) => { 
...
export const loadAccessManagementData = (param) => {  
  return function (dispatch) { 
    ...
    var headers = {
     ...
     axios.get(`${BASE_API_SOURCE.url}api/v1/template/` + (location.hostname === "localhost" ? 1 : localStorage.getItem('access_template_id')), { params, headers })
      .then((resp) => { 
...
export const loadlookup_typesData = (param) => { 
  return function (dispatch) { 
    ...
    axios.get(`${BASE_API_SOURCE.url}api/v1/core/lookup_types/list`, { params, headers })
      .then((resp) => { 
...
export const loadlookup_CodesData = (param) => { 
  return function (dispatch) { 
    ...
    axios.get(`${BASE_API_SOURCE.url}api/v1/core/lookup_codes/list`, { params, headers })
      .then((resp) => { 
