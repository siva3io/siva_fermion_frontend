...
const lookup_types_index = (props) => {
  ...
  const sortOptions = [
    {
        ...
        func: (value) => {
          dispatch(loadlookup_CodesData({ limit: params.limit, offset: params.offset, filters:params.filters, sort:JSON.stringify([["lookup_code",value]]) }))
        },
      },
      {
        label: "Display Name",
        ...
        func: (value) => {
          dispatch(loadlookup_CodesData({ limit: params.limit, offset: params.offset, filters:params.filters, sort:JSON.stringify([["display_name",value]]) }))
        },
      },
    //   {
    //     label: "Lookup Type",
  ...
  const filterSearchItems = (searchValue, searchType) => {
    ...
    dispatch( 
      dispatch(loadlookup_CodesData({ limit: params.limit, offset: params.offset, filters:JSON.stringify([[searchType,"ilike",searchValue]]) }))
    );
  }
  };
