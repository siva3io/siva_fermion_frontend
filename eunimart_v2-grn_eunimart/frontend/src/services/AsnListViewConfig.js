...
export const AccessManagement = param => {
  return {
    method: "get",
    // url: `${base_URL}/api/v1/template/2?filters=[["display_name","=","GRN"]]`,
    url: `${base_URL}/api/v1/template/${localStorage.getItem(
      "access_template_id"
    )}?filters=[["display_name","=","GRN"]]`,
