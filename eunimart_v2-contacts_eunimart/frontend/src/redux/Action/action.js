...
export const loadContactType = () => {
  return function (dispatch) {
    ...
    axios
      .get(`${BASE_API_SOURCE.url}api/v1/core/lookup_codes/contact_type`, { headers })
      .then((resp) => {
...
export const loadSelectProperty = () => {
  return function (dispatch) {
    ...
    axios
      .get(`${BASE_API_SOURCE.url}api/v1/core/lookup_codes/contact_properties`, { headers })
      .then((resp) => {
...
export const loadLocationType = () => {
  return function (dispatch) {
    ...
    axios
      .get(`${BASE_API_SOURCE.url}api/v1/core/lookup_codes/location_type`, { headers })
      .then((resp) => {
...
export const createContact = (data) => {
  return function (dispatch) {
    ...
    axios
      .post(`${BASE_API_SOURCE.url}api/v1/contacts/create`, data, { headers: headers })
      .then((resp) => {
...
export const deleteContact = (data) => {
  return function (dispatch) {
    ...
    axios
      .delete(`${BASE_API_SOURCE.url}api/v1/contacts/${data}/delete`, { headers })
      .then((resp) => {
...
export const updateContact = (data, id) => {
  return function (dispatch) {
    ...
    axios
      .post(`${BASE_API_SOURCE.url}api/v1/contacts/${id}/update`, data, { headers: headers })
      .then((resp) => {
...
export const viewAccessManagement = () => {
  return function (dispatch) {
    ...
    axios
      .get(`${BASE_API_SOURCE.url}api/v1/template/${localStorage.getItem("access_template_id")}?filters=[["display_name","=","CONTACTS"]]`, { headers })
      .then((resp) => {
