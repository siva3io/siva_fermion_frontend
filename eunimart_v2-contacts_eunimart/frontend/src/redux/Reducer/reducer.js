...
const DataReducers = (state = initialState, action) => {
  switch (action.type) {
    case types.CONTACT_TYPE:
      return {
        ...state,
        contact_type: action.payload.data,
        loading: false,
      };
    case types.LOCATION_TYPE:
      return {
        ...state,
        location_type: action.payload.data,
        loading: false,
      };
    case types.CONTACT_PROPERTY:
      return {
        ...state,
    ...
    case types.CREATE_CONTACTS_REQUEST:
      return {
        ...state,
        create_contacts_data: action.payload.data,
        loading: false,
      };
    case types.DELETE_CONTACTS_REQUEST:
      return {
        ...state,
        delete_contacts_data: action.payload.data,
        loading: false,
      };
    case types.CONTACTS_SINGLE_REQUEST:
      return {
        ...state,
        contactSingledata: action.payload.data,
        loading: false,
      };
    case types.CONTACTS_UPDATE_REQUEST:
      return {
        ...state,
    ...
    case types.CONTACTS_TABLE_REQUEST:
      return {
        ...state,
