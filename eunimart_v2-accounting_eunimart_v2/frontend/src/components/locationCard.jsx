...
const LocationCard = ({ head, pickUp_address, location_name, contact }) => {
  return (
      ...
      <CardContent sx={{ display: "flex", justifyContent: "space-between" }}>
        ...
        >
          ...
          >
            ...
            <Box sx={{}}>
              <LabeledText label="Location Name" text={location_name} />
              <LabeledText label="Pick Up Address" text={pickUp_address} />
              <LabeledText
