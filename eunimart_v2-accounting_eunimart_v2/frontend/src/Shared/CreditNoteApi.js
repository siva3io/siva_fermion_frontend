...
export const config = (searchValue) => {
  ...
  if (searchValue.display_name == "Purchase Orders") {
  ...
  if (searchValue.display_name == "Sales Orders") {
    url = `${base_URL}/api/v1/sales_orders/dropdown`;
  }
  if (searchValue.display_name === "Purchase Invoice") {
    url = `${base_URL}/api/v1/purchase_invoice/dropdown`;
  }
